...
export class Conta {
    ...
    saldo = Armazenador.obterValor("saldo") || 0;
    ...
    transacoes = Armazenador.obterValor(("transacoes"), (key, value) => {
        if (key == "data") {
    ...
    getGruposTransacoes() {
        ...
        const listaTransacoes = structuredClone(this.transacoes); // Clona a lista de transações para não modificar o original.
